...
function App() {
  ...
  const ConnectionStatus = () => (
    <div className={`fixed bottom-4 right-4 z-30 px-3 py-2 rounded-lg text-sm font-medium shadow-lg ${
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex space-x-2">
                            {/* ENHANCED PERMISSION CHECK - Only show verify if user can verify */}
                            {record.can_verify && (
                              <button
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex space-x-1">
                        ...
                        {record.can_verify && (
                          <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded" title="Can verify">
                            🔗
                          </span>
                        )}
