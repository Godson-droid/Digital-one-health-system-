  ...
  const verifyRecord = async () => {
    ...
    try {
      ...
      if (response.data?.is_verified) {
        ...
        // Don't show error toast for verification failures - handle silently
        console.log('Record integrity verification failed');
      }
    } catch (error) {
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="space-y-6">
                ...
                {blockchainHistory.length === 0 ? (
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto">
                    {blockchainHistory.map((entry, index) => (
                      <div key={index} className="bg-white border border-gray-200 rounded-2xl p-4 border-l-4 border-l-blue-500">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium text-gray-700 font-mono text-xs">
                                  {entry.user_id ? `${entry.user_id.substring(0, 8)}...` : 'Unknown'}
                                </span>
                              </div>
              ...
              <div className="bg-blue-50 p-6 rounded-2xl border border-blue-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="font-mono text-xs bg-white p-3 rounded-lg border break-all">
              ...
              <div className="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t border-gray-200">
                <button
                  ...
                  disabled={loading}
                  className="flex items-center justify-center space-x-2 px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
                  {loading ? (
                    <>
            ...
            <div className="text-center py-12">
              ...
              <button
                onClick={verifyRecord}
                className="flex items-center justify-center space-x-2 px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-all duration-200 mx-auto"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
